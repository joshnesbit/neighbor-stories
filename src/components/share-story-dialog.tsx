...
import { ShareStoryStep2 } from "./share-story-step2"; // New import
        ...
        <div className="py-4">
          ...
          {step === 2 && (
            <ShareStoryStep2
              ...
              setTranslatorAvailable={setTranslatorAvailable}
              translatorLanguage={translatorLanguage}
              setTranslatorLanguage={setTranslatorLanguage}
              languageOptions={languageOptions}
              getTranslatorLanguageOptions={getTranslatorLanguageOptions}
            />
          )}
          {step === 3 && <Step3 />}
        </div>
