...
const Step1 = ({ isMultipleStories, selectedStories, storyTitle, storyAuthor }: Step1Props) => (
...
const Step2 = ({ name, setName, contactMethod, setContactMethod, email, setEmail, phone, setPhone, isMultipleStories }: Step2Props) => (
  <div className="space-y-6">
    <div>
